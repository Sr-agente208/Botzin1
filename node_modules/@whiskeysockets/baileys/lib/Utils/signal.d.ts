import type { SignalRepositoryWithLIDStore } from '@whiskeysockets/baileys/lib/Types/index.js';
import type { AuthenticationCreds, AuthenticationState, KeyPair, SignalIdentity, SignalKeyStore, SignedKeyPair } from '@whiskeysockets/baileys/lib/Types/Auth.js';
import { type BinaryNode, type FullJid } from '@whiskeysockets/baileys/lib/WABinary/index.js';
import type { USyncQueryResultList } from '@whiskeysockets/baileys/lib/WAUSync/index.js';
