...
import { type MediaType } from '@whiskeysockets/baileys/lib/Defaults/index.js';
import type { DownloadableMessage, MediaConnInfo, MediaDecryptionKeyInfo, SocketConfig, WAMediaUpload, WAMediaUploadFunction, WAMessageContent, WAMessageKey } from '@whiskeysockets/baileys/lib/Types/index.js';
import { type BinaryNode } from '@whiskeysockets/baileys/lib/WABinary/index.js';
