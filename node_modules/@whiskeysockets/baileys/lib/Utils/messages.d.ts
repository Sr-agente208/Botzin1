...
import type { AnyMediaMessageContent, AnyMessageContent, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, WAMessage, WAMessageContent, WAMessageKey } from '@whiskeysockets/baileys/src/Types/index.js';
import type { ILogger } from '@whiskeysockets/baileys/src/Utils/logger.js';
import { type MediaDownloadOptions } from '@whiskeysockets/baileys/src/Utils/messages-media.js';
...
export declare const generateLinkPreviewIfRequired: (text: string, getUrlInfo: MessageGenerationOptions["getUrlInfo"], logger: MessageGenerationOptions["logger"]) => Promise<import("@whiskeysockets/baileys/src/Types/index.js").WAUrlInfo | undefined>;
