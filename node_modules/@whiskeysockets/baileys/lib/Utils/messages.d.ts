...
import type { AnyMediaMessageContent, AnyMessageContent, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, WAMessage, WAMessageContent, WAMessageKey } from '@whiskeysockets/baileys/lib/Types/index.js';
import type { ILogger } from '@whiskeysockets/baileys/lib/Utils/logger.js';
import { type MediaDownloadOptions } from '@whiskeysockets/baileys/lib/Utils/messages-media.js';
...
export declare const generateLinkPreviewIfRequired: (text: string, getUrlInfo: MessageGenerationOptions["getUrlInfo"], logger: MessageGenerationOptions["logger"]) => Promise<import("@whiskeysockets/baileys/lib/Types/index.js").WAUrlInfo | undefined>;
